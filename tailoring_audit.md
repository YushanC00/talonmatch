...
Use this checklist to verify that the **Dynamic Section Refactor** is rendering correctly in the `TailoredResumeDrawer` or dedicated workstation view.

---

## 1. Visual Geometry & Branding

- [ ] **Zero-Radius:** Are all cards and buttons in the drawer/workstation strictly 0px (sharp corners)?
