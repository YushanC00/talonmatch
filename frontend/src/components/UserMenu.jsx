  ...
  if (!user) {
    ...
    return (
      <div className="relative" ref={menuRef}>
        ...
        {open && (
          <div className="absolute right-0 top-full mt-2.5 w-64 bg-white rounded-xl border border-gray-100 overflow-hidden z-50">
            {/* Header */}
            ...
            <div className="p-3">
              <button
                ...
                className="w-full flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-xl border border-gray-200 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-colors cursor-pointer"
              >
                <GoogleIcon />
