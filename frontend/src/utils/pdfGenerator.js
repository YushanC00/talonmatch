 ...
 *
 * @param {object} params
 * @param {object} params.tailoredData  - full response from tailorResume API
 * @param {string} params.jobTitle      - job title string
 * @param {string} params.company       - company name string
 * @returns {jsPDF} doc — call .save(filename) or .output('blob') on the result
 */
export function buildResumePdf({ tailoredData, jobTitle, company }) {
...
export function downloadResumePdf({ tailoredData, jobTitle, company }) {
